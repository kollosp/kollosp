...
* GUI [Modbus](https://en.wikipedia.org/wiki/Modbus) master and slave applications (Node.js, Express.js, Bulma, Websocket) [link](https://github.com/kollosp/ModbusConsole)
# Hobbies
